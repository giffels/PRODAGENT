...
if(isset($_GET['root_tag']))
	$root_tag=$_GET['root_tag'];
...
if($root_tag=="Production")
	array_push($black_child,'sitename','ce','se');
...
To modify a <?=$root_tag?>, select the <?=$root_tag?> to modify, edit appropriate fields and click "Modify button"<br>
To add a <?=$root_tag?>  select the <?=$root_tag?>  similar, edit appropriate fields and click "Add <?=$root_tag?> field"<br>
...
<input type="hidden" name="xml_file" id="xml_file_id" value="<?=$xml_file?>">
<input type="hidden" name="root_tag" id="root_tag_id" value="<?=$root_tag?>">
<input type="hidden" name="Name_list" id="Name_list_id" value="<?=$Name_list?>">
<?
if($select_name_prod!='-1'){
?>
<input type='button' value='Add <?=$root_tag?> ' onclick='update_xml("update")'>
&nbsp;<input type='button' value='Modify <?=$root_tag?> ' onclick='update_xml("modify")'>
&nbsp;<input type='button' value='Delete <?=$root_tag?> ' onclick='update_xml("delete")'>
<br>
...
function select_name_prod(){
	global $xml_file,$select_name_prod, $Name_list, $root_tag;
	$dokument = domxml_open_file($xml_file);
	...
	echo "<option value='-1'>select a $root_tag</option>";
