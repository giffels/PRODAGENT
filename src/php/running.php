<?php
  ...
  # Running jobs lpage of the the Production Agent web interface
  #
  ...
  echo "<h2>Select running jobs:</h2><br>";
  ...
  // start form
  echo '<form action="./running.php" method="get">';
  ...
  if (isset($_GET['submit'])) {
    ...
    if ($cmssw) {
      ...
      echo "<h2>Running jobs information:</h2><br>";
      ...
      while ($row = mysql_fetch_array($result, MYSQL_ASSOC)) {
        ...
        if ($headers_printed == 0) {
          ...
          // print table header
          start_table();
          table_headers(array('Job id','Submission date','Start time',
