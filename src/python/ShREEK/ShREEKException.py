...
General Exception class for ShREEK modules

"""

__version__ = "$Revision: 1.1 $"
__revision__ = "$Id: ShREEKException.py,v 1.1 2005/12/30 18:54:25 evansde Exp $"

import exceptions
import inspect


class ShREEKException(exceptions.Exception):
    """
    _ShREEKException_
