...
General Exception class for SVSuite modules
...
class SVSuiteError(exceptions.Exception):
    """
    _SVSuiteError_
...
class SVSuiteToolFailure(SVSuiteError):
    """
    _SVSuiteToolFailure_

    Exception for a failed tool

    """
    def __init__(self, msg , **args):
        SVSuiteError.__init__(self, msg, **args)
        self.exitStatus = 900002

class SVSuiteStageInFailure(SVSuiteError):
    """
    _SVSuiteStageInFailure_

    Exception for a failed stage in 

    """
    def __init__(self, msg , **args):
        SVSuiteError.__init__(self, msg, **args)
        self.exitStatus = 900003
