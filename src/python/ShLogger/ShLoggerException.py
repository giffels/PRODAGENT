...
General Exception class for ShLogger modules

"""

__version__ = "$Revision: 1.1 $"
__revision__ = "$Id: ShLoggerException.py,v 1.1 2005/12/30 18:57:45 evansde Exp $"

import exceptions
import inspect


class ShLoggerException(exceptions.Exception):
    """
    _ShLoggerException_
