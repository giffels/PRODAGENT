...
__revision__ = "$Id: TrackingComponent.py,v 1.47.2.22 2008/04/24 09:23:59 gcodispo Exp $"
__version__ = "$Revision: 1.47.2.22 $"
...
class TrackingComponent:
    ...
    def startComponent(self):
        ...
        params['OutParams'] = {} # needed just by GetOutput
