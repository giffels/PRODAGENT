#!/usr/bin/env python
"""
Util to test the RssFeeder component startup for development by
...
# arguments
argsDict = {"ItemListLength" : 100,
            "ProdAgentName" : None,
            "Port" : 8100,
            }

# options
valid = ["ItemListLength=", "ProdAgentName=", "Port="
         ]
...
# start component
comp = RssFeederComponent(**argsDict)
comp.startComponent()
