#!/usr/bin/env python
"""
_SizePolicyIgnoringZeroEventsFiles__

Policy for merge based on file size ignoring files with 0 events.
...
class SizePolicyIgnoringZeroEventsFiles:
    """
    _SizePolicyIgnoringZeroEventsFiles_
...
registerMergePolicy(SizePolicyIgnoringZeroEventsFiles, \
                    SizePolicyIgnoringZeroEventsFiles.__name__)
