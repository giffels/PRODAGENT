...
"""
  ...
  --fake-hash Switch that generates UUIDs in place of the PSetHash as a work
    around for the PSetHash Problems in DBS.
...
WorkflowTools.addStageOutNode(cmsRun, "stageOut1")
WorkflowTools.generateFilenames(spec)
